...
public interface SetorRepository extends JpaRepository<Setor, Integer> {
	...
	List<Setor> findAllByIdOrgaoAndIdLocalidadeAndUnidade(@Param("idOrgao") Integer idOrgao, @Param("idLocalidade") Integer idLocalidade,
			@Param("idUnidade") Integer idUnidade);
